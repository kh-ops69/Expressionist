...
# the code to be added - give user the option to click n number of photos of himself in different poses
# with emotions such as excited, sad, angry, or some other unique pre defined pose in gesture_recoginition code

# after this, perform style transfer on the images that were clicked by the user through a GUI , based on
# the type of emotion recognised in gesture recognition- so this code will have to be encapsulated inside 
# a class and called for each of the photos taken - reduced number of epochs and other params to 
# make computation easier - and return the final output images(not the ones at every iteration) to the user

# POSSIBLE TODO?: try to reduce response time through the UI to the user
